...
*/
	...
	add_filter( 'enter_title_here', 'testimonials_change_title' );
	
	function testimonials_change_title( $title ) {
	...
	function testimonials_meta( $post ){
		global $post;
		$post_id = $post->ID;
	...
	function save_testimonials( $post_id ){
		if ( defined( 'DOING_AUTOSAVE' ) && DOING_AUTOSAVE ) return $post_id;
	
		//Security check, data comming from the right form:
		if ( ! isset( $_POST['testimonials_info_nonce'] ) || ! $_POST['testimonials_info_nonce'] = 'testimonials_info_nonce' . $post_id ) return $post_id;
	...
	*/
	...
	function testimonials_custom_columns( $col, $post_id ){
